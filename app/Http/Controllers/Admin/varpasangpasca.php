...
class varpasangpasca extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('var_pasang_baru_pascabayar')->where('id', $id)->update([
            'daya' => $request->daya,
            'slo' => $request->slo,
            'gil' => $request->gil,
            'ujl' => $request->ujl,
    ...
    public function delete($id_slo)
    {
        ...
        DB::table('var_pasang_baru_pascabayar')->where('id', $id_slo)->delete();
        return redirect('admin/varpasangpasca')->with(['sukses' => 'Data telah dihapus']);
    }
}
