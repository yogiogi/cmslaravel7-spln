...
class varubahprapasca extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('var_perubahan_daya_pra_pasca')->where('id', $id)->update([
            'daya' => $request->daya,
            'slo' => $request->slo,
            'gil' => $request->gil,
            'ujl' => $request->ujl,
    ...
    public function delete($id_slo)
    {
        ...
        DB::table('var_perubahan_daya_pra_pasca')->where('id', $id_slo)->delete();
        return redirect('admin/varubahprapasca')->with(['sukses' => 'Data telah dihapus']);
    }
}
