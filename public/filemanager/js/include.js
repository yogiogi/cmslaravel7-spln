        ...
        s = {
                ...
                edit_text_file: function(e) {
                    !(function(a) {
                        ...
                        y.ajax({
                            type: "POST",
                            url:
                                "ajax_calls.php?action=get_file&sub_action=edit&preview_mode=text",
                            data: { path: t }
                        }).done(function(e) {
                            bootbox.dialog(
                                e,
                                            ...
                                            window.editor &&
                                                ...
                                                y
                                                    .ajax({
                                                        type: "POST",
                                                        url:
                                                            "execute.php?action=save_text_file",
                                                        data: {
                                                            path: t,
                                                            new_content: e
                                                        }
            ...
            makeUploader: function() {
                jQuery("#fileupload").fileupload({
                    ...
                    jQuery("#fileupload").bind("fileuploaddrop", function(
                        e,
                        a
                    ) {
                    ...
                    jQuery("#fileupload").bind("fileuploadsubmit", function(
                        e,
                        a
                    ) {
                        a.formData = {
                            ...
                            { label: jQuery("#cancel").val(), class: "btn" },
                            {
                                ...
                                callback: function() {
                                    ...
                                    y.ajax({
                                        type: "POST",
                                        url:
                                            "ajax_calls.php?action=change_lang",
                                        data: { choosen_lang: a }
                                    }).done(function(e) {
                                        "" != e
                                            ? bootbox.alert(e)
                                        ...
                                        callback: function() {
                                            ...
                                            if (null !== e) {
                                                ...
                                                y.ajax({
                                                    type: "POST",
                                                    url:
                                                        "execute.php?action=create_file",
                                                    data: {
                                                        path: t,
                                                        name: e,
                                                        new_content: a
                            ...
                            1 == e &&
                                y
                                    .ajax({
                                        type: "POST",
                                        url:
                                            "ajax_calls.php?action=clear_clipboard",
                                        data: {}
                                    })
                                    .done(function(e) {
                                        "" != e
                                        ...
                                        : ((a =
                                          ...
                                          y
                                              .ajax({
                                                  type: "POST",
                                                  url:
                                                      "execute.php?action=paste_clipboard",
                                                  data: { path: a }
                                              })
                                              .done(function(e) {
                                                  "" != e
