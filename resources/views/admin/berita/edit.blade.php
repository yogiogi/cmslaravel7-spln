...
<select name="jenis_berita" class="form-control select2">
  ...
  <option value="Panduan" <?php if($berita->jenis_berita=="Panduan") { echo "selected"; } ?>>Panduan</option>
  <option value="Tarif" <?php if($berita->jenis_berita=="Tarif") { echo "selected"; } ?>>Tarif Pemeriksaan</option>
</select>
</div>
