...
<?php $i=1; foreach($pengaduanteknis as $pengaduanteknis) { ?>
...
<tr class="odd gradeX">
    <td>
        ...
        <small>
            ...
            <br>tanggal daftar : <?php if($pengaduanteknis->tgl_permohonan != 0) { echo date("d/m/Y", strtotime($pengaduanteknis->tgl_permohonan)); } else {echo "-";} ?>
            <br>tanggal selesai : <?php if($pengaduanteknis->tgl_approve != 0) { echo date("d/m/Y", strtotime($pengaduanteknis->tgl_approve)); } else {echo "-";} ?>
        </small>
    </td>
    <td>
      <small>
    ...
    <td>
      <a><?php if($pengaduanteknis->status==0) { echo"Belum Diselesaikan ";} else if($pengaduanteknis->status==1){ echo"Sudah diselesaikan ";} ?><sup></sup></a>
    </td>
    <td>
      <div class="btn-group">
        ...
        <a href="{{ asset('admin/pengaduanteknis/delete/'.$pengaduanteknis->id) }}" 
