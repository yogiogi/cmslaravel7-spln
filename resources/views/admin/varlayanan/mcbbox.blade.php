                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form action="" accept-charset="utf-8">
                                    <input type="hidden" name="id" value="{{ $varmcbbox->id }}">
                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Daya : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="daya" name="daya" value=<?php echo $varmcbbox->daya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Harga MCB : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="mcb" name="mcb" value=<?php echo $varmcbbox->harga_mcb ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Harga MCCB : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="mccb" name="mccb" value=<?php echo $varmcbbox->harga_mccb ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Harga LNB : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="lnb" name="lnb" value=<?php echo $varmcbbox->harga_lnb ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Harga Trafo : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="trafo" name="trafo" value=<?php echo $varmcbbox->harga_trafo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">MDP : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="mdp" name="mdp" value=<?php echo $varmcbbox->mdp ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SDP : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="sdp" name="sdp" value=<?php echo $varmcbbox->sdp ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="slo" name="slo" value=<?php echo $varmcbbox->slo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="gil" name="fil" value=<?php echo $varmcbbox->gil ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ujl" name="ujl" value=<?php echo $varmcbbox->ujl ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ujl" name="ujl" value=<?php echo $varmcbbox->materai ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ppn" name="ppn" value=<?php echo $varmcbbox->ppn ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="ppj" name="ppj" value=<?php echo $varmcbbox->ppj ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Status : </label>
                                        <div class="col-sm-8">
                                            <?php if ($varmcbbox->status == 0) {
                                                echo "Belum Diselesaikan ";
                                            } else if ($varmcbbox->status == 1) {
            ...
            <div class="modal-body">
                ...
                <form action="" accept-charset="utf-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga MCB : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tbmcb" name="tbmcb" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga MCCB : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tbmccb" name="tbmccb" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga LNB : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tblnb" name="tb" valnblue="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga Trafo : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tbtrafo" name="tbtrafo" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">MDP : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tbmdp" name="tbmdp" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">SDP : </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tbsdp" name="tbsdp" value="">
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" href="http://spln.co.id/admin/varmcbbox/" onclick="javascript:window.location.reload()" data-dismiss="modal">Oke</button>
            </div>
        </div>
    </div>
</div>