            ...
            <div class="modal-body">
                ...
                <form action="" accept-charset="utf-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga MCB : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbmcb" name="tbmcb" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga MCCB : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbmccb" name="tbmccb" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga LNB : </label>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga Trafo : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbtrafo" name="tbtrafo" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Harga Box MCB : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbbox" name="tbbox" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">MDP : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbmdp" name="tbmdp" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">SDP : </label>
                        <div class="col-sm-8">
                            <input type="number" step="any" class="form-control" id="tbsdp" name="tbsdp" value="0">
                        </div>
                    </div>
