                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="varpasangpasca/update/{{ $varpasangpasca->id }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="daya" name="daya" value=<?php echo $varpasangpasca->daya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="slo" name="slo" value=<?php echo $varpasangpasca->slo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="gil" name="gil" value=<?php echo $varpasangpasca->gil ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ujl" name="ujl" value=<?php echo $varpasangpasca->ujl ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="materai" name="materai" value=<?php echo $varpasangpasca->materai ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="biaya" name="biaya" value=<?php echo $varpasangpasca->biaya ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppn" name="ppn" value=<?php echo $varpasangpasca->PPN ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppj" name="ppj" value=<?php echo $varpasangpasca->PPJ ?>>
                                        </div>
                                    </div>
