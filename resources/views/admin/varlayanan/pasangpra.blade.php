...
<script>
    $(document).ready(function() {
        $('#tambahButton').on('click', function() {
            ...
            $.ajax({
                url: '{{ url("admin/varpasangpra/tambah") }}',
                type: "POST",
                headers: {
...
<div class="table-responsive mailbox-messages">
    <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <?php $i = 1;
            foreach ($varpasangbarupra as $varpasangbarupra) { ?>
                <tr class="odd gradeX">
                    <td>
                        <?php echo $varpasangbarupra->daya ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->slo ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->gil ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->ujl ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->materai ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->biaya ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->PPN ?>
                    </td>
                    <td>
                        <?php echo $varpasangbarupra->PPJ ?>
                    </td>
                    <td>
                        <div class="btn-group">
                            <a href="#modalEditdata" class="btn btn-info btn-sm " data-toggle="modal" data-target="#modalEditdata<?php echo $varpasangbarupra->id ?>"><i class="fas fa-edit"></i></a>
                            <a href="{{ asset('admin/varpasangpra/delete/'.$varpasangbarupra->id) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
                        </div>
                    </td>
                </tr>

                <div class="modal fade" id="modalEditdata<?php echo $varpasangbarupra->id ?>" tabindex="-1" aria-labelledby="modalEditdata" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="varpasangpra/update/{{ $varpasangbarupra->id }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="daya" name="daya" value=<?php echo $varpasangbarupra->daya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="slo" name="slo" value=<?php echo $varpasangbarupra->slo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="gil" name="gil" value=<?php echo $varpasangbarupra->gil ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ujl" name="ujl" value=<?php echo $varpasangbarupra->ujl ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="materai" name="materai" value=<?php echo $varpasangbarupra->materai ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="biaya" name="biaya" value=<?php echo $varpasangbarupra->biaya ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppn" name="ppn" value=<?php echo $varpasangbarupra->PPN ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppj" name="ppj" value=<?php echo $varpasangbarupra->PPJ ?>>
                                        </div>
                                    </div>
