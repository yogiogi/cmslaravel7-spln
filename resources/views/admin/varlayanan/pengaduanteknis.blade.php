...
<script>
    $(document).ready(function() {
        $('#tambahButton').on('click', function() {
            $.ajax({
                url: '{{ url("admin/varpengaduanteknis/tambah") }}',
                type: "POST",
                headers: {
...
<div class="table-responsive mailbox-messages">
    <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <?php $i = 1;
            foreach ($varpengaduan as $varpengaduan) { ?>
                <tr class="odd gradeX">
                    <td>
                        <?php echo $varpengaduan->daya ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->slo ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->gil ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->ujl ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->materai ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->biaya ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->PPN ?>
                    </td>
                    <td>
                        <?php echo $varpengaduan->PPJ ?>
                    </td>
                    <td>
                        <div class="btn-group">
                            <a href="#modalPengaduanTeknis" class="btn btn-info btn-sm " data-toggle="modal" data-target="#modalPengaduanTeknis<?php echo $varpengaduan->id ?>"><i class="fas fa-edit"></i></a>
                            <a href="{{ asset('admin/varpengaduanteknis/delete/'.$varpengaduan->id) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
                        </div>
                    </td>
                </tr>

                <div class="modal fade" id="modalPengaduanTeknis<?php echo $varpengaduan->id ?>" tabindex="-1" aria-labelledby="modalPengaduanTeknis" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form action="" accept-charset="utf-8">
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Daya : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbdaya" name="tbdaya" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbslo" name="tbslo" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbgil" name="tbgil" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">UJL : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbujl" name="tbujl" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Materai : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbmaterai" name="tbmaterai" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">Biaya : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbbiaya" name="tbbiaya" value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">PPN : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbppn" name="tbppn" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="tbppj" name="tbppj" value="0">
                        </div>
                    </div>
