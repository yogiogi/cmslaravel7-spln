...
<script>
    $(document).ready(function() {
        $('#tambahButton').on('click', function() {
            ...
            $.ajax({
                url: '{{ url("admin/varubahpascapasca/tambah") }}',
                type: "POST",
                headers: {
...
<div class="table-responsive mailbox-messages">
    <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <?php $i = 1;
            foreach ($varpascapasca as $varpascapasca) { ?>
                <tr class="odd gradeX">
                    <td>
                        <?php echo $varpascapasca->daya ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->slo ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->gil ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->ujl ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->materai ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->biaya ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->PPN ?>
                    </td>
                    <td>
                        <?php echo $varpascapasca->PPJ ?>
                    </td>
                    <td>
                        <div class="btn-group">
                            <a href="#modalEditdata" class="btn btn-info btn-sm " data-toggle="modal" data-target="#modalEditdata<?php echo $varpascapasca->id ?>"><i class="fas fa-edit"></i></a>
                            <a href="{{ asset('admin/varubahpascapasca/delete/'.$varpascapasca->id) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
                        </div>
                    </td>
                </tr>

                <div class="modal fade" id="modalEditdata<?php echo $varpascapasca->id ?>" tabindex="-1" aria-labelledby="modalEditdata" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="varubahpascapasca/update/{{ $varpascapasca->id }}" method="POST">
                                    <input type="hidden" name="id" id="id" value=<?php echo $varpascapasca->id ?>>
                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">Daya : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="daya" name="daya" value=<?php echo $varpascapasca->daya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="slo" name="slo" value=<?php echo $varpascapasca->slo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="gil" name="gil" value=<?php echo $varpascapasca->gil ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ujl" name="ujl" value=<?php echo $varpascapasca->ujl ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="materai" name="materai" value=<?php echo $varpascapasca->materai ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="biaya" name="biaya" value=<?php echo $varpascapasca->biaya ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppn" name="ppn" value=<?php echo $varpascapasca->PPN ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                                        <div class="col-sm-8">
                                            <input type="number" step="any" class="form-control" id="ppj" name="ppj" value=<?php echo $varpascapasca->PPJ ?>>
                                        </div>
                                    </div>
