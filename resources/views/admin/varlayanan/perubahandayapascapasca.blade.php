...
<script>
    ...
    //         $.ajax({
    //             url: '{{ url("admin/varubahpascapasca/update") }}',
    //             type: "POST",
    //             headers: {
                            ...
                            <div class="modal-body">
                                ...
                                <form action="varubahpascapasca/update/{{ $varpascapasca->id }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="daya" name="daya" value=<?php echo $varpascapasca->daya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">SLO : </label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="slo" name="slo" value=<?php echo $varpascapasca->slo ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">GIL : </label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="gil" name="gil" value=<?php echo $varpascapasca->gil ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="ujl" name="ujl" value=<?php echo $varpascapasca->ujl ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="materai" name="materai" value=<?php echo $varpascapasca->materai ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="biaya" name="biaya" value=<?php echo $varpascapasca->biaya ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">UJL : </label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="ppn" name="ppn" value=<?php echo $varpascapasca->PPN ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 control-label text-right" for="">PPJ : </label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="ppj" name="ppj" value=<?php echo $varpascapasca->PPJ ?>>
                                        </div>
                                    </div>
