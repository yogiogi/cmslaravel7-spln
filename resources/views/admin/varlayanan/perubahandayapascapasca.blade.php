...
<script>
    ...
    $(document).ready(function() {
        $('#tambahButton').on('click', function() {
            ...
            $.ajax({
                url: '{{ url("admin/varpascapasca/tambah") }}',
                type: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        <tbody>
            ...
            foreach ($varpascapasca as $varpascapasca) { ?>
                <tr class="odd gradeX">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="#modalPengaduanTeknis" class="btn btn-info btn-sm " data-toggle="modal" data-target="#modalPengaduanTeknis<?php echo $varpascapasca->id ?>"><i class="fas fa-edit"></i></a>
                ...
                <div class="modal fade" id="modalPengaduanTeknis<?php echo $varpascapasca->id ?>" tabindex="-1" aria-labelledby="modalPengaduanTeknis" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" accept-charset="utf-8">
                                    <input type="hidden" name="id" value="{{ $varpascapasca->id }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <?php if ($varpascapasca->status == 0) {
                                                echo "Belum Diselesaikan ";
                                            } else if ($varpascapasca->status == 1) {
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" href="http://spln.co.id/admin/varpascapasca/" onclick="javascript:window.location.reload()" data-dismiss="modal">Oke</button>
            </div>
        </div>
    </div>
</div>