            ...
            <div class="col-md-10 text-left">
              ...
              <form action="" accept-charset="utf-8" >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="number" id='jam_nyala' name="jam_nyala" class="form-control" placeholder="Isi dengan jumlah jam nyala" value="{{ old('jam_nyala') }}" required>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Hari nyala </label>
                  <div class="col-sm-8">
                    <input type="number" id='hari_nyala' name="hari_nyala" class="form-control" placeholder="Isi dengan jumlah hari nyala" value="{{ old('hari_nyala') }}" required>
                  </div>
                </div>
