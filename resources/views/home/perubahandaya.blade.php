...
<script>
  $(document).ready(function() {
    ...
    $('#submithitung').on('click', function() {
      ...
      if (nama.value != '' && ktp.value != '' && alamat.value != '' && provinsi.value != 0 && kabupaten.value != 0 &&
        kecamatan.value != 0 && desa.value != 0 && email.value != '' && telepon_pemohon.value != '' && whatsapp.value != '' &&
        email.value != '' && layanan.value != 0 && id_pelanggan.value != "" && no_meter.value != "" && peruntukan.value != "") {
        $.ajax({
          type: "GET",
