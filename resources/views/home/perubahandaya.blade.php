          ...
          <div class="row">
            ...
            <div class="col-md-10 text-left">
              ...
              <form action="" accept-charset="utf-8" method="post">
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Daya Lama (Va)</label>
                  <div class="col-md-8">
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Daya Baru (Va)</label>
                  <div class="col-md-8">
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Peruntukan </label>
                  <div class="col-sm-8">
