        ...
        <div class="kotak">
          <div class="row">
            ...
            <div class="col-md-8 text-left">
              ...
              @endif
              <form action="instalasi" method="get" accept-charset="utf-8">
                {{ csrf_field() }}
                <input type="hidden" name="token_rahasia" value="72827582Uduagd86275gbdahgahgfa">
              
                <p class="alert alert-info">
                  Isi data instalasi listrik Anda dengan lengkap dan benar.
                </p>
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Titik lampu <span class="text-danger">*</span></label>
                  <div class="col-sm-8">
                    <input type="number" name="titik_lampu" class="form-control" placeholder="Isi dengan jumlah titik lampu" value="{{ old('ttik_lampu') }}" required>
                  </div>
                </div>
                
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Titik saklar <span class="text-danger">*</span></label>
                  <div class="col-sm-8">
                    <input type="number" name="titik_saklar" class="form-control" placeholder="Isi dengan jumlah titik saklar" value="{{ old('titik_saklar') }}" required>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Titik stop kontak <span class="text-danger">*</span></label>
                  <div class="col-sm-8">
                    <input type="number" name="titik_stop" class="form-control" placeholder="Isi dengan jumlah titik stop kontak" value="{{ old('titik_saklar') }}" required>
                  </div>
                </div>
          ...
          <div class="form-group column">
            ...
            <p>
              ...
              <br><?php echo $layanan ?>
              <br>Detail Biaya
              <br>- Biaya: <?php echo $biaya ?>
              <br>- Titik lampu: <?php echo $instalasi->titik_lampu ?>
              <br>- Titik saklar: <?php echo $instalasi->titik_saklar ?>
              <br>- Titik stop kontak: <?php echo $tinstalasi->itik_stop_kontak ?>
              <br>- PPN 10 %: <?php echo $instalasi->ppn ?>
              <br>- PPJ 5%: <?php echo $instalasi->ppj ?>
              <br>- Materai: <?php echo $instalasi->materai ?>
              <br>Total: <?php echo $instalasi->total ?>
            </p>
          </div>
        </div>
      </div>
