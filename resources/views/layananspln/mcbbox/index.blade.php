        ...
        <div class="kotak">
          <div class="row">
            ...
            <div class="col-md-8 text-left">
              ...
              @endif
              <form action="mcbbox" method="get" accept-charset="utf-8">
                {{ csrf_field() }}
                <input type="hidden" name="token_rahasia" value="72827582Uduagd86275gbdahgahgfa">
              
                <p class="alert alert-info">
                  Isi data pemasangan MCB box Anda dengan lengkap dan benar.
                </p>
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Grup MCB <span class="text-danger">*</span></label>
                  <div class="col-sm-8">
                    <input type="number" name="grup_mcb" class="form-control" placeholder="Isi dengan jumlah grup MCB" value="{{ old('nomer_ktp') }}" required>
                  </div>
                </div>
          ...
          <div class="form-group column">
            ...
            <p>
              <strong>Biaya Pasang Baru</strong>
              <br><?php echo $layanan ?>
              <br>Detail Biaya
              <br>- Biaya penyambungan: <?php echo $pasang_mcbbox->biaya ?>
              <br>- Grup MCB: <?php echo $pasang_mcbbox-grup_mcb ?>
              <br>- PPN 10 %: <?php echo $pasang_mcbbox->ppn ?>
              <br>- PPJ 5%: <?php echo $pasang_mcbbox->ppj ?>
              <br>- Materai: <?php echo $pasang_mcbbox->materai ?>
              <br>- Total: <?php echo $pasang_mcbbox->total ?>
            </p>
          </div>
        </div>
      </div>
