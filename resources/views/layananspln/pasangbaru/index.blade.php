        ...
        <div class="kotak">
          <div class="row">
            ...
            <div class="col-md-8 text-left">
              ...
              @endif
              <form action="pasangbaru" method="get" accept-charset="utf-8">
                {{ csrf_field() }}
                <input type="hidden" name="token_rahasia" value="72827582Uduagd86275gbdahgahgfa">
              
                <p class="alert alert-info">
                  Isi data pemsangan baru Anda dengan lengkap dan benar.
                </p>
                ...
                <div class="form-group row">
                  <label class="col-sm-4 control-label text-right">Daya Sambung</label>
                  <div class="col-md-8">
                    <select name="daya" id="daya" class="form-control select2">
          ...
          <div class="form-group column">
            ...
            <p>
              ...
              <br><?php echo $layanan ?>
              <br>Detail Biaya
              <br>- Biaya penyambungan: <?php echo $biaya ?>
              <br>- SLO: <?php echo $slo ?>
              <br>- GIL: <?php echo $pasang_baru->gil ?>
              @if($layanan == 2)
              <br>- UJL: <?php echo $pasang_baru->ujl ?>
              @endif
              <br>- PPN 10 %: <?php echo $pasang_baru->ppn ?>
              <br>- PPJ 5%: <?php echo $pasang_baru->ppj ?>
              <br>- Token: <?php echo $pasang_baru->token ?>
              <br>- Materai: <?php echo $pasang_baru->materai ?>
              <br>Total: <?php echo $pasang_baru->total ?>
            </p>
          </div>
        </div>
      </div>
